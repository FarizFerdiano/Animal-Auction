...
<section>
        ...
        <div class="container">
            <div class="card bg-warning-subtle border-warning p-1 my-3 mb-4 shadow-sm">
                <form class="d-flex" role="search">
                    ...
                    <a href="#" class="btn btn-warning d-flex text-light" type="submit"><img src="{{ asset('icons/feather_FFFFFF/search.svg') }}">
                        <span class="ms-1">
                            Search
                        </span>
                    </a>
        ...
        <div class="container">
            <div class="card shadow-sm p-3 mb-5">
                <h5 class="mb-3"><img src="{{ asset('icons/feather_E88D13/coin-stack.svg') }}"><span class="ms-1">Mybid</span></h5>
                {{-- Rows my bid --}}
                {{-- Row --}}
                <div class="row border-bottom mb-3 d-flex">
                    <div class="col-7 d-flex align-items-top gap-3">
                        {{-- foto --}}
                        <div class="col-sm-1">
                                <img src="{{ asset('img/Foto produk_sample.png') }}" class="rounded img-fluid" alt="...">
                        </div>
                        {{-- Left content --}}
                        <div class="">
                            {{-- Nama product --}}
                            <p class="mb-2">Kambing Etawa jantan umur 2 bulan</p>
                            {{-- Nama pemilik --}}
                    ...
                    {{-- Alert situation --}}
                        ...
                        {{-- <div class="badge text-bg-success text-success mb-2 fw-bold">
                            <img src="{{ asset('icons/feather_20_328D2A/mingcute_auction.svg') }}">
                            <span class="ms-1">Anda Menang</span>
                        </div> --}}
                        {{-- Kalah --}}
                        {{-- <div class="badge text-bg-danger text-danger mb-2 fw-bold">
                            <img src="{{ asset('icons/feather_FF1221/mingcute_auction.svg') }}">
                            <span class="ms-1">Anda Kalah</span>
                        </div> --}}
                        {{-- Price --}}
                        <h4><img clas="" src="{{ asset('icons/feather_328D2A/ph_money.svg') }}">
