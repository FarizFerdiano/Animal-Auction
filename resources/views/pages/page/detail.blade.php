                ...
                <div class="row g-4">
                  ...
                  <div class="col d-flex">
                    <div class="card-body p-0">
                      {{-- Nama produk --}}
                      <h5 class="card-title fs-3 mb-3">Kambing Etawa jantan umur 2 bulan sehat sejahtera</h5>
                      {{-- time auction --}}
                      <div class="time-auction  badge text-bg-warning text-warning mb-2 fw-bold mb-2"> <img src="{{ asset('icons/feather_FFB800/clock.svg') }}">
