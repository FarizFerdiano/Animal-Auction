              ...
              <form action="{{ route('auctions.update', $auction) }}" method="post" enctype="multipart/form-data">
                ...
                @switch($auction->status)
                  ...
                  @case('open')
                    ...
                    <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure want to close this auction? After closing, this auction cannot receive any bids.')">                      <i class="bi bi-x-lg"></i>
                      Close
                    </button>
                    @break
